...
echo ""
echo "⚠️  TEST BRANCH - For testing automation only"
echo ""
...
# Use custom branch if instructed, otherwise default to test
FEDPUNK_REF="${FEDPUNK_REF:-test}"

echo -e "\nCloning Fedpunk from: https://github.com/${FEDPUNK_REPO}.git"
echo -e "\e[33mUsing TEST branch: $FEDPUNK_REF\e[0m"
